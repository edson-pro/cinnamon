...
export default function Footer() {
  return (
    <div className="footer bg-[#1C1C1C] pb-8 pt-16 ">
      <div className="max-w-6xl gap-10 grid grid-cols-5 mx-auto px-3">
        ...
        <div className="col-span-3">
          ...
          <div className="grid grid-cols-2 mt-20 items-center justify-between gap-10">
      ...
      <div className="w-full h-[1.5px] bg-opacity-30 bg-gray-600 my-8 max-w-6xl px-3 mx-auto"></div>
      <div className="max-w-6xl flex items-center justify-between mx-auto px-3">
